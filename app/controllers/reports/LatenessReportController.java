 ...
 */
@Transactional
public class LatenessReportController extends Controller{

    private final FormFactory formFactory;
    private final JPAApi jpaApi;

    @Inject
    public LatenessReportController(FormFactory formFactory, JPAApi jpaApi) {
    ...
    public Result index(String roleType){
        ...
        modelMap.put("selectedTab", "latenessReport");
        modelMap.put("latenessReport",  getLatenessReport());
        return ok(views.html.reports.lateness_report.render(modelMap));
    }

    public List<Attendance> getLatenessReport() {
        ...
        List<Attendance> latenessList = entityManager.createQuery("SELECT a FROM Attendance a " +
